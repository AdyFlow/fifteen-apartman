...
const partners: Partner[] = [
  ...
  {
    id: 'petepan',
    name: 'Pete Pan Tattoo Studio',
    motto: '',
    logo: '/pete_pan.webp',
    description: [],
    website: 'https://www.facebook.com/share/17vCD45WN4/?mibextid=wwXIfr',
    isOnline: false,
    isRecommended: false,
    buttonText: 'Facebook oldal megtekintése'
  }
          ...
          <div ref={sectionRef} className="flex flex-col items-center gap-8 mb-16">
            {partners.map((partner, index) => (
              ...
              >
                ...
                {(partner.isRecommended || partner.customBadgeText || partner.isOnline) && (
